...
class MyFlutterApp {
  ...
  static const IconData nation = IconData(0xe800, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData bacteria = IconData(0xe801, fontFamily: _kFontFam, fontPackage: _kFontPkg);
